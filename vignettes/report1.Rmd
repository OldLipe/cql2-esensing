---
title: "CQL2 development report - Milestone: 'Proof of concept version with examples that validate the idea of using the package'"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{CQL2 development report}
