...
This report describes the activities performed in the first 3 months of the development project of CQL2 extension for R. The activities conducted are related to the first milestone of the project, scheduled to end on August 31, 2022. The report shows how the current CQL2 extension works in R and provides various examples of its use. The current version of the CQL2 extension can be accessed at https://github.com/e-sensing/cql2exp.
...
CQL2 filters in TEXT format are sometimes represented the same way as in R expression.
...
The scalar data types are: `string`, `number`, `boolean`, `timestamp`, and `date`.
...
This report describes the delivery of the first milestone, named "Proof of concept version with examples that validate the idea of using the package."

To complete this milestone, activities **A1** and **A2** were performed. This milestone was scheduled to be delivered in current month (**M3**, after the completion of activity **A2**).

The project's next step is to complete the second milestone, named "Implementing integration testing with STAC services supporting CQL2", which involves activities **A3** and **A4**. This integration will be performed on the Microsoft Planetary computer service.
