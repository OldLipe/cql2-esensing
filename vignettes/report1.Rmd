...
In this report, we show how CQL2 package works and provide a variety of examples of its use. The current version of CQL2 package can be accessed in https://github.com/e-sensing/cql2exp.
